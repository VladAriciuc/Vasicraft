...
import net.mcreator.vasicraft.procedures.Chair_healthProcedure;
...
public class ChairEntity extends PathfinderMob {
	public ChairEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(VasiCraftModEntities.CHAIR.get(), world);
	}
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("vasi_craft:silent_sound"));
	}
	...
	public void baseTick() {
		super.baseTick();
		Chair_healthProcedure.execute(this);
	}
