...
import net.mcreator.vasicraft.procedures.ButtonTransferProcedure;
...
public class AtmguiButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			ButtonTransferProcedure.execute(world, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		VasiCraftMod.addNetworkMessage(AtmguiButtonMessage.class, AtmguiButtonMessage::buffer, AtmguiButtonMessage::new, AtmguiButtonMessage::handler);
	}
}
