...
public class LegopotguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public LegopotguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(VasiCraftModMenus.LEGOPOTGUI.get(), id);
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 133, 35) {
			...
			@Override
			public boolean mayPlace(ItemStack stack) {
				return VasiCraftModItems.BUG_SPRAY.get() == stack.getItem();
			}
		}));
