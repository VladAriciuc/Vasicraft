...
import net.mcreator.vasicraft.procedures.Atm_tickProcedure;
...
public class AtmguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public AtmguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(VasiCraftModMenus.ATMGUI.get(), id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof AtmguiMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			Atm_tickProcedure.execute(world, entity);
		}
	}
}
