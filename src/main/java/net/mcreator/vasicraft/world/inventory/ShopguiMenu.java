...
import net.mcreator.vasicraft.procedures.Shop_gui_opened_tickProcedure;
...
public class ShopguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ShopguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(VasiCraftModMenus.SHOPGUI.get(), id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof ShopguiMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			Shop_gui_opened_tickProcedure.execute(world, entity);
		}
	}
}
