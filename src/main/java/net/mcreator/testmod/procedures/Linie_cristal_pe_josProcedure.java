...
public class Linie_cristal_pe_josProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (world.isEmptyBlock(BlockPos.containing(x, y + 1, z))) {
			...
			world.setBlock(BlockPos.containing(x, y + 1, z), VasiCraftModBlocks.LINIECRISTAL.get().defaultBlockState(), 3);
			if (new Object() {
				...
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(VasiCraftModItems.CRISTAL.get());
