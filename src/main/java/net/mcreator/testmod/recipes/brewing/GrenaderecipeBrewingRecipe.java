...
package net.mcreator.testmod.recipes.brewing;
...
public class GrenaderecipeBrewingRecipe implements IBrewingRecipe {
	...
	public boolean isIngredient(ItemStack ingredient) {
		return Ingredient.of(new ItemStack(VasiCraftModItems.ZEROSAPTE.get())).test(ingredient);
	}

	@Override
	public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
		if (isInput(input) && isIngredient(ingredient)) {
			return new ItemStack(VasiCraftModItems.GRENADA.get());
		}
